...
-- This file creates the necessary tables for user authentication and profiles
...
CREATE TABLE IF NOT EXISTS user_bookmarks (
    ...
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    UNIQUE(user_id, course_id, university_id, bookmark_type)
);
...
INSERT INTO user_achievements (user_id, achievement_type, achievement_name, description, points) VALUES
('00000000-0000-0000-0000-000000000000', 'milestone', 'First Course', 'Enrolled in your first course', 10),
('00000000-0000-0000-0000-000000000000', 'milestone', 'Course Completion', 'Completed your first course', 50),
('00000000-0000-0000-0000-000000000000', 'milestone', 'Learning Streak', 'Maintained a 7-day learning streak', 25),
('00000000-0000-0000-0000-000000000000', 'milestone', 'Certificate Earned', 'Earned your first certificate', 100)
