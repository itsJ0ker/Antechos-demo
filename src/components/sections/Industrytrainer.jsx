      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto text-sm sm:text-base">
            Meet experienced trainers who bring industry knowledge and hands-on
            learning to your growth journey.
          </p>
        </div>
                ...
                <div>
                  <div className="flex items-center gap-6 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">{trainer.profile}</p>
                    </div>
                  </div>
                  ...
                  <div className="text-sm text-gray-200 mb-2">
                    ...
                    {trainer.expertise.slice(0, 3).join(", ")}...
                  </div>
                </div>
...
export default IndustryTrainer;
