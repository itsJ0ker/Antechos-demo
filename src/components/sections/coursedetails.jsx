          ...
          <div className="flex-1 space-y-8">
            ...
            >
              ...
              <p className="text-gray-700 mb-4 leading-relaxed text-sm md:text-base">
                Upon successful completion, you'll receive a verified certificate that demonstrates your expertise. 
                This certificate is recognized by top companies worldwide and can be added to your LinkedIn profile.
              </p>
            ...
            >
              ...
              <div className="space-y-4">
                {course.educators?.map((educator, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-4 p-4 border border-gray-200 rounded-xl bg-gradient-to-r from-gray-50 to-blue-50"
                  >
                    <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-r from-blue-400 to-purple-600 rounded-full flex items-center justify-center text-white font-bold flex-shrink-0">
                      {educator.name?.split(' ').map(n => n[0]).join('')}
                    </div>
                    <div className="flex-1 min-w-0">
                      <h3 className="font-bold text-gray-900 truncate text-sm md:text-base">{educator.name}</h3>
                      <p className="text-gray-600 text-sm truncate">{educator.role} - {educator.company}</p>
                      <div className="flex items-center gap-4 mt-1">
                        <div className="flex items-center gap-1">
                          <Star className="w-4 h-4 text-yellow-400 fill-current" />
                          <span className="text-sm font-semibold">{educator.rating}</span>
                        </div>
                        <div className="text-sm text-gray-500">{educator.students} students</div>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-semibold text-sm">
                Fee: {course.negoprice && (
                  <span className="line-through opacity-60">{course.negoprice}</span>
                )}
              </div>
