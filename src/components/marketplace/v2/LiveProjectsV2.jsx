...
const ProjectCardV2 = ({ project, index }) => {
  ...
  return (
    <motion.div
      ...
      className="v2-card p-7 bg-[var(--v2-bg)] flex flex-col group h-full hover:border-[var(--v2-accent)] relative overflow-hidden"
    >
      <div className="flex items-start justify-between mb-8 relative z-10">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-100 dark:border-indigo-500/20 flex items-center justify-center text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform">
            <Briefcase size={22} />
          </div>
          <div>
      ...
      <div className="space-y-6 mb-8">
         <div className="flex items-center justify-between text-xs font-black uppercase tracking-widest text-[var(--v2-text-muted)]">
            <span className="flex items-center gap-2"><MapPin size={12} /> {project.location || 'Remote (Global)'}</span>
            <span className="flex items-center gap-2 text-emerald-500"><TrendingUp size={12} /> {project.urgency} Urgency</span>
         </div>
         
         <div className="grid grid-cols-2 gap-6 p-4 rounded-2xl bg-[var(--v2-bg-subtle)] border border-[var(--v2-border)] group-hover:border-indigo-100 dark:group-hover:border-indigo-900/30 transition-colors">
            <div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-20">
          ...
          >
            ...
            <h2 className="v2-heading text-4xl sm:text-5xl mb-6 text-[var(--v2-text-main)]">Live Project <span className="v2-gradient-text">Neural Feed.</span></h2>
          ...
          >
            <button className="v2-btn v2-btn-secondary !bg-[var(--v2-bg)] !text-[var(--v2-text-main)] !border-[var(--v2-border)] !px-8 !py-4 flex items-center gap-2 group hover:shadow-xl transition-all">
              Market Analytics <BarChart3 size={16} className="text-indigo-500" />
            </button>
            <button className="v2-btn v2-btn-primary !bg-indigo-600 !border-indigo-600 !text-white !px-8 !py-4 flex items-center gap-2 shadow-2xl shadow-indigo-500/20 group">
        ...
        <motion.div 
           ...
           className="mt-20 p-10 sm:p-16 rounded-[3rem] bg-slate-900 dark:bg-slate-800 text-white flex flex-col md:flex-row items-center justify-between gap-12 relative overflow-hidden shadow-[0_40px_80px_-20px_rgba(0,0,0,0.3)]"
        >
          ...
          <div className="relative z-10 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-6">
               ...
               <span className="text-sm font-black uppercase tracking-[0.3em] text-indigo-300">Enterprise Protocol</span>
            </div>
            <h3 className="text-3xl sm:text-5xl font-black mb-6 leading-[1.1]">Join the elite <br /> talent network.</h3>
            <p className="text-indigo-100 text-lg sm:text-xl max-w-xl font-medium leading-relaxed mb-0">
               Get priority access to pre-vetted projects and direct invitations from Fortune 500 engineering teams.
            </p>
          </div>
          
          <div className="relative z-10 flex flex-col gap-4 w-full md:w-auto">
            <button className="v2-btn !bg-white !text-indigo-600 !px-12 !py-6 !rounded-2xl shadow-2xl shadow-black/20 font-black text-lg flex items-center justify-center gap-3 group">
              Apply as Talent <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
            </button>
            <p className="text-[10px] font-black text-indigo-300/60 uppercase tracking-[0.2em] text-center">
